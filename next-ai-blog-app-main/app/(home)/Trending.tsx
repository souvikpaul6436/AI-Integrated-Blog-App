  ...
  return (
    <section className="pt-3 pb-10">
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm">
          Artificial intelligence is not a substitute for human intelligence; it
          is a tool to amplify human creativity and ingenuity.
        </p>
      </div>
      ...
      <p className="text-sm">
        Artificial intelligence (AI) is playing an increasingly-prevalent role
        in our everyday lives, and is one of today’s most-talked about topics
