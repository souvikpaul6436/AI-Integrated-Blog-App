...
const Article = ({
 ...
 const postAiContent = async () => {
   ...
   if (
     role.match("I am a sarcastic individual") ||
     role.match("I am a sarcastic individual.")
   ) {
   ...
   if (
     role.match("I am a helpful assistant.") ||
     role.match("I am a helpful assistant")
   ) {
   ...
   if (
     role.match("I am an aggressive individual") ||
     role.match("I am a aggressive individual.")
   ) {
...
//   const postVideoSummary = async () => {
//     editor.chain().focus().setContent("Generating Video Summary. Please Wait...").run();
